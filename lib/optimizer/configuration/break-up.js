...
function animation(property, configuration, validator) {
  ...
  if (values.length > 1 && _anyIsInherit(values)) {
    throw new InvalidPropertyError('Invalid animation values at ' + formatPosition(values[0][2][0]) + '. Ignoring property \'' + property.name + '\'.');
  }
  ...
  for (i = 0, l = values.length; i < l; i++) {
    ...
    if (validator.isTime(value[1]) && !durationSet) {
      ...
      throw new InvalidPropertyError('Invalid animation value at ' + formatPosition(value[2][0]) + '. Ignoring property \'' + property.name + '\'.');
    }
  }
...
function background(property, configuration, validator) {
  ...
  if (!anyValueSet) {
    throw new InvalidPropertyError('Invalid background value at ' + formatPosition(values[0][2][0]) + '. Ignoring property \'' + property.name + '\'.');
  }
...
function borderRadius(property, configuration) {
  ...
  if (splitAt === 0 || splitAt === values.length - 1) {
    throw new InvalidPropertyError('Invalid border-radius value at ' + formatPosition(values[0][2][0]) + '. Ignoring property \'' + property.name + '\'.');
  }
...
function font(property, configuration, validator) {
  ...
  if (!values[index]) {
    throw new InvalidPropertyError('Missing font values at ' + formatPosition(property.all[property.position][1][2][0]) + '. Ignoring property \'' + property.name + '\'.');
  }
  ...
  if (values.length < 2 || !_anyIsFontSize(values, validator) || !_anyIsFontFamily(values, validator)) {
    throw new InvalidPropertyError('Invalid font values at ' + formatPosition(property.all[property.position][1][2][0]) + '. Ignoring property \'' + property.name + '\'.');
  }

  if (values.length > 1 && _anyIsInherit(values)) {
    throw new InvalidPropertyError('Invalid font values at ' + formatPosition(values[0][2][0]) + '. Ignoring property \'' + property.name + '\'.');
  }
  ...
  while (index < fuzzyMatched) {
    ...
    if (isStyleValid && !isStyleSet) {
      ...
      throw new InvalidPropertyError('Invalid font style / variant / weight / stretch value at ' + formatPosition(values[0][2][0]) + '. Ignoring property \'' + property.name + '\'.');
    } else {
      break;
    }
  ...
  if (validator.isFontSizeKeyword(values[index][1]) || validator.isUnit(values[index][1]) && !validator.isDynamicUnit(values[index][1])) {
    ...
    throw new InvalidPropertyError('Missing font size at ' + formatPosition(values[0][2][0]) + '. Ignoring property \'' + property.name + '\'.');
  }

  if (!values[index]) {
    throw new InvalidPropertyError('Missing font family at ' + formatPosition(values[0][2][0]) + '. Ignoring property \'' + property.name + '\'.');
  }
...
function listStyle(property, configuration, validator) {
  ...
  if (values.length > 0) {
    throw new InvalidPropertyError('Invalid value of \'' + values[0][1] + '\' at ' + formatPosition(values[0][2][0]) + '. Ignoring property \'' + property.name + '\'.');
  }
