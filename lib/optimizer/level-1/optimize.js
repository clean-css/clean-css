...
function optimizeBody(rule, properties, context) {
  ...
  for (i = 0, l = _properties.length; i < l; i++) {
    ...
    propertyOptimizer = configuration[config] && configuration[config].propertyOptimizer || noop;
    valueOptimizers = configuration[config] && configuration[config].valueOptimizers || [optimizers.whiteSpace];
