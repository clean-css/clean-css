  ...
  var breakUp = {
    ...
    background: function (token) {
      ...
      var color = {
        ...
        value: processable["background-color"].defaultValue,
        isImportant: token.isImportant
      };
      var image = {
        prop: "background-image",
        value: processable["background-image"].defaultValue,
        isImportant: token.isImportant
      };
      var repeat = {
        prop: "background-repeat",
        value: processable["background-repeat"].defaultValue,
        isImportant: token.isImportant
      };
      var position = {
        prop: "background-position",
        value: processable["background-position"].defaultValue,
        isImportant: token.isImportant
      };
      var attachment = {
        prop: "background-attachment",
        value: processable["background-attachment"].defaultValue,
        isImportant: token.isImportant
      };
    ...
    listStyle: function (token) {
      ...
      var type = {
        ...
        value: processable["list-style-type"].defaultValue,
        isImportant: token.isImportant
      };
      var position = {
        prop: "list-style-position",
        value: processable["list-style-position"].defaultValue,
        isImportant: token.isImportant
      };
      var image = {
        prop: "list-style-image",
        value: processable["list-style-image"].defaultValue,
        isImportant: token.isImportant
      };
      var result = [type, position, image];
